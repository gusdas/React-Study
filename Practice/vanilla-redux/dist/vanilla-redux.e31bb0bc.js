...
var btnDecrease = document.querySelector('#decrease'); //액션이름정의

var TOGGLE_SWITCH = 'TOGLE_SWITCH';
...
var store = (0, _redux.createStore)(reducer); //상태가 업데이트 될 때마다 호출 리액트와 다르게 이미 html을 사용하여 만들어진 UI의 속성을 상태에 따라 변경
...
render(); //구독(스토어의 상태가 바뀔 때마다 render함수 호출)
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2043" + '/');
